...
Scenario: Delete an Order
    When I visit the "Home Page"
    And I set the "Customer" to "11199"
    And I set the "Date" to "04/22/2021"
    And I press the "Create" button
    Then I should see the message "Success"
    When I copy the "Id" field
    ...
    And I should not see "11199" in the results
...
Scenario: Search for order by date
    When I visit the "Home Page"
    And I set the "Date" to "03-17-2022"
    And I press the "Search" button
    Then I should see "65434" in the results